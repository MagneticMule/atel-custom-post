...
class YoulistenMenuCustomizer {
    ...
    /**
     * remove menu item from the admin menu using the menu's php class file (this is weak).
     * What will be hidden can depend on the user role. This will need beefed up a bit later.
